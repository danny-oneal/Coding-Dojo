...
function orderedMultisetUnion(sortedA, sortedB) {
    if (sortedA.length < 1) return sortedB;
    if (sortedB.length < 1) return sortedA;
...
console.log(orderedMultisetUnion(numbers1A, numbers1B), expected1);
// console.log(orderedMultisetUnion(numbers2A, numbers2B), expected2);
// console.log(orderedMultisetUnion(numbers3A, numbers3B), expected3);
// console.log(orderedMultisetUnion(numbers4A, numbers4B), expected4);
// console.log(orderedMultisetUnion(numbers5A, numbers5B), expected5);
