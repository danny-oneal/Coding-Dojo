...
console.log(interleaveArrays(arrA1, arrB1), expected1B); //  [1, "a", 2, "b", 3, "c"];
console.log(interleaveArrays(arrA2, arrB2), expected2B); // [1, 2, 3, 4, 6, 8];
console.log(interleaveArrays(arrA3, arrB3), expected3B); // [1, 2, 3, 4, 5, 7];
console.log(interleaveArrays(arrA4, arrB4), expected4B); // [42, 0, 6];
